...
/// # Variants
///
/// - `HomeDirNotFound`: The user's home directory could not be found.
/// - `InvalidPath`: The provided path is invalid.
/// - `FailedToCreateConfigDir`: The program's config dir failed to be created.
/// - `ProjDirsNotFound`: The programs directories are not found
#[derive(Debug)]
